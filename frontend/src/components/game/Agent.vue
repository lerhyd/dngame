        ...
        <div id="notebook-paper" v-if="isNoteOpen===true">
          <div id="content">
            ...
            <div v-if="isFakeNewsOpen===true">
              <input class="form-note-input" type="text" v-model="entryForm.desc" placeholder="Описание новости" required>
              <br>
              <datetime
              ...
              <p>Выберете регион, где всё произошло.</p>
              <div class="select-custom">
                <select class="form-control" v-model="commonRegion.continent">
              ...
              <div class="select-custom">
                <select class="form-control" v-model="commonRegion.country" v-if="commonRegion.continent!=null">
              ...
              <div class="select-custom">
                <select class="form-control" v-model="commonRegion.city" v-if="commonRegion.country!=null">
                  <option value="null" disabled>Город</option>
                  <option v-for="city in this.$store.getters.cities" v-bind:value="city">{{city}}</option>
                </select>
              </div>
              <p>Выберете регион, на который будут распространяться новости.</p>
              <div class="select-custom">
                <select class="form-control" v-model="distRegion.continent">
                ...
                <select class="form-control" v-model="distRegion.country" v-if="distRegion.continent!=null">
                ...
                <select class="form-control" v-model="distRegion.city" v-if="distRegion.country!=null">
